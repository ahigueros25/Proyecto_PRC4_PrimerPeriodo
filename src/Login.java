...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String Usuatio = jTextField1.getText();
        String Clave = jPasswordField1.getText();

        if (Usuatio.isEmpty() || Clave.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Error, Campos sin rellenar");
        } else {
            if (Usuatio.equals("admin") && Clave.equals("admin123")) {
                JOptionPane.showMessageDialog(null, "Bienvenido Administrador");
            } else {
                if (Usuatio.equals("vendedor") && Clave.equals("vendedor123")) {
                    JOptionPane.showMessageDialog(null, "Bienvenido Vendedor");
                } else {
                    if (Usuatio.equals("invitado") && Clave.equals("invitado123")) {
